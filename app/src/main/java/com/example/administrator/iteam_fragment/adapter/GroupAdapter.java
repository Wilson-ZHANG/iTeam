...
import com.example.administrator.iteam_fragment.Constant;
...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.ViewHolder> {
    ...
    public GroupAdapter(List<Map<String, Object>> listitems, MainActivity mActivity){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        holder.openImage.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(EaseConstant.EXTRA_USER_ID,teamid);
                mainActivity.startActivity(intent);
            }
        });
