...
import com.example.administrator.iteam_fragment.util.AlbumHelper;
import com.example.administrator.iteam_fragment.util.Bimp;
import com.example.administrator.iteam_fragment.util.ImageBucket;
...
public class AlbumActivity extends Activity {
    ...
    private class AlbumSendListener implements View.OnClickListener {
        public void onClick(View v) {
            ...
            intent.putExtra("files",Bimp.tempSelectBitmap);
            startActivity(intent);
            finish();
        }
