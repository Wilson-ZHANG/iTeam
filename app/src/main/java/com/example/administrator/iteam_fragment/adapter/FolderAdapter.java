...
import com.example.administrator.iteam_fragment.ImageFile;
import com.example.administrator.iteam_fragment.R;
import com.example.administrator.iteam_fragment.util.BitmapCache;
import com.example.administrator.iteam_fragment.util.ImageItem;
import com.example.administrator.iteam_fragment.AlbumActivity;
import com.example.administrator.iteam_fragment.ShowAllPhoto;

import java.util.ArrayList;

/**
 * Created by SML on 2017/5/6 0006.
 */
...
//			holder.imageView.setImageBitmap( AlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
    ...
    private class ImageViewClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ImageFile.instance.finish();//关闭ImageFile活动，不然在选中照片提交之后，可能会回到选择相册页面
