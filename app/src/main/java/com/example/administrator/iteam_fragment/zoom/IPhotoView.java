...
public interface IPhotoView {
    ...
    /**
     * Whether to allow the ImageView's parent to intercept the touch event when the group_image1 is scroll to it's horizontal edge.
     */
    ...
    /**
     * Allows you to enable/disable the com.example.administrator.iteam_fragment.zoom functionality on the ImageView.
     * When disable the ImageView reverts to using the FIT_CENTER matrix.
     *
     * @param zoomable - Whether the com.example.administrator.iteam_fragment.zoom functionality is enabled.
     */
     ...
     *
     * @param scale  - Scale to com.example.administrator.iteam_fragment.zoom to
