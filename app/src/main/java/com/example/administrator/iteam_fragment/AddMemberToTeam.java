...
public class AddMemberToTeam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_member_to_team);
    ...
    private void initView() {
        friendImage  = (ImageView)findViewById(R.id.member_result_image);
        friendPhone = (EditText)findViewById(R.id.search_member_phone);
        friendName = (TextView)findViewById(R.id.member_result_name);
        buttonSearch = (Button) findViewById(R.id.search_member_phone_button);
        buttonAdd = (Button)findViewById(R.id.add_member_result_button);
    ...
    private void addFriend() {
        Log.d( "attempAddMTT:---", "begin");

        String url = "http://127.0.0.1/iteam/addMemberToTeam.php";
        String cookie = pref.getString("cookie", null);
        Log.d( "refreshMain: ", cookie+"bc");
        ...
        HttpUtil.getUtilsInstance().doPost(url, cookie,param, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Log.d("AMTT", "onFailure: noresponse");
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                String responseText = response.body().string();
                Log.d("AMTT_response", responseText);
